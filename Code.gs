 ...
 */
const CONFIG = {
  SHEET_ID: "1DGklnfm5yBsB7WEY-5PRlqLEs9Qv2cvQtJ-TKqbp-rI", // ID Spreadsheet Database
  SHEET_NAME: "Sheet1",                                     // Nama Sheet
  PARENT_FOLDER_ID: "1Afa2K2g6XVm37-eIyhvtitqisYs5hgyc",    // ID Folder Induk Siswa
  LEDGER_FOLDER_ID: "1-ljzk0KoxH79FhUe-3oidgL8_OvHA63S"     // ID Folder Ledger
};
